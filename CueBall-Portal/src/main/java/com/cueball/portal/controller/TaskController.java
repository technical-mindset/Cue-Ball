...
import com.cueball.portal.service.TaskService;
...
public class TaskController {
    ...
    @PreAuthorize("hasAnyRole('ROLE_SUPER_ADMIN', 'ROLE_ADMIN')")
    public TaskDTO getById(@PathVariable("id")int id){
    ...
    @PreAuthorize("hasAnyRole('ROLE_SUPER_ADMIN', 'ROLE_ADMIN')")
    public ModelAndView addUpdate(@Valid @ModelAttribute("dto") TaskDTO dto, BindingResult result, RedirectAttributes redirectAttributes) {
