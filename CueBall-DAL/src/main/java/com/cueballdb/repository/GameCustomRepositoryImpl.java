...
public class GameCustomRepositoryImpl extends AbstractPersistenceManager<Game> implements GameCustomRepository {

    @Override
    public List<Game> findAllByFilters(String search, Integer enable, Integer pageNumber, Integer pageSize, long[] count) {
