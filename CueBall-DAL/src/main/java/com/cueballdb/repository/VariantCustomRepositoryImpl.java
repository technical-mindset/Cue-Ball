...
public class VariantCustomRepositoryImpl extends AbstractPersistenceManager<Variant> implements VariantCustomRepository {


    @Override
    public List<Variant> findAllByFilters(String search, Integer enable, Integer pageNumber, Integer pageSize, long[] count) {
